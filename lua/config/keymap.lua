...
local insert_mermaid_chunk = function()
  insert_code_chunk 'mermaid'
end
...
local function new_terminal(lang)
  vim.cmd('tabnew term://' .. lang)
  -- vim.cmd('tabnew term:///usr/bin/env bash -il ' .. lang)
  -- vim.cmd('vsplit term://' .. lang)
  -- vim.cmd('!tmux split-window -hd ' .. "'" .. lang .. "'")
end
...
local function new_terminal_ipython()
  new_terminal 'JAX_PLATFORMS=cpu ipython --ext=autoreload -i --no-banner'
...
wk.add({
  {
    { '<leader>w', '<cmd>write<cr>', desc = 'write buffer' },
    ...
    { '<leader>om', insert_mermaid_chunk, desc = '[p]ython code chunk' },
